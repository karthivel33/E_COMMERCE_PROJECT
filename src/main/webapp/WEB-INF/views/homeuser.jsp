  ...
  <div class="container-fluid">
    <div class="navbar-header">
					<ul class="nav navbar-nav">
						...
						<li><a href="product/productList"><span
								class="glyphicon glyphicon-tags"></span> VIEW PRODUCTS</a></li>
						 <li><a href="#"><span class="glyphicon glyphicon-user"></span>
								${author}</a></li>
								 <li><a href="<c:url value="/j_spring_security_logout" />">SIGNOUT</a></li>
	...
	<div class="carousel slide carousel-fade" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			 ...
			 <div  class="item active">
				<img class="img-responsive" src="resources/images/zp.jpg" />
			</div>
			<div class="item">
				<img class="img-responsive" src="resources/images/hero01.jpg" />
			</div>
			<div class="item">
				<img class="img-responsive" src="resources/images/hero02.jpg" />
			</div>
			<div class="item">
				<img class="img-responsive" src="resources/images/zi.jpg" />
			</div>
		</div>
	</div>
